...
export interface DappInterfaceMulticallInterface extends utils.Interface {
  functions: {
...
export interface DappInterfaceMulticall extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DappInterfaceMulticallInterface;
